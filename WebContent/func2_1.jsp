...
<html>
	...
	String make_name = request.getParameter("name"); 
	String sql = "select * from vehicle v,make m where v.is_opened = 1 and v.vehicle_makeid = make_id and make_name = "+"'"+make_name+"'";
