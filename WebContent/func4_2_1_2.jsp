...
<html>
	...
	String new_mileage=request.getParameter("mileage");
	String sql = "update vehicle set mileage="+new_mileage+" where vehicle_id="+vehicle_id;
	System.out.println(sql);
	Statement stmt = conn.createStatement();
	int res = stmt.executeUpdate(sql);
	
	if(res==1)
		out.write("<h2 align='center'>"+request.getParameter("vehicle_number")+"번 차량 주행거리 수정 완료 ("+new_mileage+"km)</h2>");
