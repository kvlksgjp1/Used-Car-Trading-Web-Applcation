...
<html>
	...
	String sql = "update vehicle set price="+new_price+" where vehicle_id="+vehicle_id;
	System.out.println(sql);
	Statement stmt = conn.createStatement();
	int res = stmt.executeUpdate(sql);
	
	if(res==1)
		out.write("<h2 align='center'>"+request.getParameter("vehicle_number")+"번 차량 가격 수정 완료 ("+new_price+"만원)</h2>");
