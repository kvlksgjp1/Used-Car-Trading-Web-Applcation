...
<html>
	...
	String sql = "update vehicle set is_opened=0 where vehicle_id="+request.getParameter("vehicle_number");
	System.out.println(sql);
	Statement stmt = conn.createStatement();
	int res = stmt.executeUpdate(sql);
	
	if(res==1)
		out.write("<h2 align='center'>"+request.getParameter("vehicle_number")+"차량 비공개 처리 완료</h2>");
